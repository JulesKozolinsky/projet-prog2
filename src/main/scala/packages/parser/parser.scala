...
object Parser
{
  ...
  def parse (file:String) : List[Round] = {
    ...
    r1 = (Set(new Tuple2(m1,1), new Tuple2(m2,1), new Tuple2(m3,1), new Tuple2(m4,1), new Tuple2(m5,1), new Tuple2(m6,1) ),1)::r1
    ...
    r2 = (new Tuple2(Set(new Tuple2(m2,2)),7))::r2
    r2 = (new Tuple2(Set(new Tuple2(m1,3)),10))::r2
